...
[kayac_siniflandirma_resnet50_model, info] = trainNetwork(egitim_veriseti_aug, lgraph, options);

tahmin = classify(kayac_siniflandirma_resnet50_model, test_veriseti_aug);
...
save('C:\Users\Muhammet\Desktop\kayac_siniflandirma\resnet50\kayac_siniflandirma_resnet50_egitim.mat', ...
    'kayac_siniflandirma_resnet50_model');