...
new_conv = convolution2dLayer(1, kategori_sayisi, ...
    'Name', 'new_conv', ...
    'WeightLearnRateFactor', 10, ...
    'BiasLearnRateFactor', 10);
lgraph = replaceLayer(lgraph, 'conv19', new_conv);

new_softmax = softmaxLayer('Name', 'new_softmax');
lgraph = replaceLayer(lgraph, 'softmax', new_softmax);
...
[kayac_siniflandirma_darknet19_model, info] = trainNetwork(egitim_veriseti_aug, lgraph, options);

tahmin = classify(kayac_siniflandirma_darknet19_model, test_veriseti_aug);
...
save('C:\Users\Muhammet\Desktop\kayac_siniflandirma\darknet19\kayac_siniflandirma_darknet19_egitim.mat', ...
    'kayac_siniflandirma_darknet19_model');