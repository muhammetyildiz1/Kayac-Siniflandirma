...
[kayac_siniflandirma_googlenet_model, info] = trainNetwork(egitim_veriseti_aug, lgraph, options);

tahmin = classify(kayac_siniflandirma_googlenet_model, test_veriseti_aug);
...
save('C:\Users\Muhammet\Desktop\kayac_siniflandirma\googlenet\kayac_siniflandirma_googlenet_egitim.mat', ...
    'kayac_siniflandirma_googlenet_model');