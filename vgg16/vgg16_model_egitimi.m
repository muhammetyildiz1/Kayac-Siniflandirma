...
[kayac_siniflandirma_vgg16_model, info] = trainNetwork(egitim_veriseti_aug, lgraph, options);

tahmin = classify(kayac_siniflandirma_vgg16_model, test_veriseti_aug);
...
save('C:\Users\Muhammet\Desktop\kayac_siniflandirma\vgg16\kayac_siniflandirma_vgg16_egitim.mat', ...
    'kayac_siniflandirma_vgg16_model');